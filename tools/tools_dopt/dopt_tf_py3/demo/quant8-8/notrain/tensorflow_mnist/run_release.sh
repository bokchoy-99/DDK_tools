...
python3 ${ROOT}/dopt_so.py  --framework 3 -m   0   --model ./basemodel/mnist.pb --cal_conf ./config.prototxt --output  ./curmodel/finalmodel.pb --input_format  NHWC   --input_shape   "Placeholder:1,28,28,1"   --out_nodes  "Softmax" --compress_conf  ./curmodel/mnist_param --device_idx   0
